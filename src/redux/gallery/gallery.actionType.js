...
export const GET_USER_FAV_IMAGES_REQUEST = "GET_USER_FAV_IMAGES_REQUEST";
export const GET_USER_FAV_IMAGES_SUCCESS = "GET_USER_FAV_IMAGES_SUCCESS";
export const GET_USER_FAV_IMAGES_FAILED = "GET_USER_FAV_IMAGES_FAILED";
